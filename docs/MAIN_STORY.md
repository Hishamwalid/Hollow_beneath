...
For seven hundred years, certain people have experienced the same dream: an impossible version of themselves, power without limit, the promise of becoming the best they could possibly be. They are called **Seekers**.

The journal's final entry, in shaky, almost childlike handwriting:
...
The light from above shrinks to a coin, then a needle, then nothing.

---

## 2. The World of the Descent
...
| Chapter | Name | Nodes | Landmark |
|---------|------|-------|----------|
| 1 | The Archive Opens | 1–40 | The Argent Sentinel |
| 2 | The Sable March | 41–80 | Patriarch Oren Cass |
| 3 | The Singing Deep | 81–120 | The Merged Chorus |
| 4 | The Reach of Dust | 121–160 | The Fossil King |
| 5 | The Final Descent | 161–200 | The Final Reflection |
...
> *"I found the Loom. It showed me myself... The thing in the Deep isn't promising us power. It's showing us what we are willing to sacrifice for it."*
> *"And I am afraid that I already said yes."*

The **Fossil King**, last of a court of stone, weeps where she wept: *"Not for herself. For the next one."*

### Chapter 5 — The Final Descent
In the Ashen Tunnels, Eve's voice admits the truth gently — *"Are you really my mother?" / "Does it matter?" / "Yes." / "That's what I said too."* At the Covenant Spire, Eve herself appears — translucent, present, the age she was when she died. She explains the cycle: she tried to stop the next Seeker by defeating them; saving them meant becoming part of the mechanism. *"The only way to save someone is to let them choose. Even if they choose wrong."* And then, fading: *"The thing waiting at the end of the journey... is you."*

At the Final Chamber stands the **Final Reflection** — the PLAYER, but finished. It is not an enemy; it is a completion. The thought they were too afraid to finish.
...
The Reflection shatters like a mirror. The Loom hums: *"You finished the thought."* Power floods in — absolute, unimaginable, empty. The PLAYER understands too late: the Reflection was the *previous* Hollow. They sit on the throne of dust and silver and wait. A new Seeker arrives, fever-bright with the dream. The Hollow raises a hand; the Seeker's own techniques shadow around them.
...
The climb takes weeks. Sunlight. Home. Then the slow draining: mother's face, reason, name. Years pass. In a small room with dust on every surface, the PLAYER holds a journal they cannot read and tries to breathe — and has forgotten how. The journal falls open; the handwriting is theirs now, shaky, childlike: *"The Deep stares at you..."* Somewhere below, the Hollow waits for the next Seeker. The cycle has not been broken. Only delayed.

### Credits
Over black, Eve's voice one last time — not from the journal, but from memory or from the Loom itself:

> *"But freedom isn't the same as escape."*

---

## 5. Story Variables (systems reference)

| Variable | Purpose | Set at |
|----------|---------|--------|
| `story.eveVoiceHeard` (0–5) | Flavor counter; gates Reflection phase-4 line at ≥3 | Nodes 8, 92, 175, 185 |
| `story.motherJournalFound` | Unlocks Reflection phase-4 branch ("She already said yes.") | Node 155 |
| `flags.final_reflection_defeated` | → THE HOLLOW | CombatScene victory override |
| `flags.final_reflection_lost` + `ending_choice_dark` | → LOST IN THE DARK | TheOffer scene |
| `flags.final_reflection_lost` + `ending_choice_climb` | → THE RETURN | TheOffer scene |

Faction influence (Sable / Archive / Covenant / Caravan) no longer decides endings — it only colors the **epilogue overlay** during credits (highest ≥25; tie priority Sable > Archive > Covenant > Caravan).

---

*Related docs: `SCENES.md` (full script), `ENEMIES_AND_BOSSES.md`, `WORLD_AND_FACTIONS.md`, `ART_AUDIO_ASSETS.md`, `ROADMAP.md`.*
