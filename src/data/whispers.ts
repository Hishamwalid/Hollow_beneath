...
export const WHISPERS: WhisperDef[] = [
  ...
  { id: 'w_stable_08', tier: 'stable', context: 'menu', text: 'You catch yourself rereading your own notes, as if someone else wrote them.' },
  { id: 'w_stable_09', tier: 'stable', context: 'menu', text: 'The tablet in your pack is warm. It has never been warm before.' },
  ...
  { id: 'w_stable_13', tier: 'stable', context: 'menu', text: "Curiosity is not a flaw. It is just the part of you that hasn't been hurt yet." },
  ...
  { id: 'w_awakened_08', tier: 'awakened', context: 'menu', text: 'You reread an old choice of yours and no longer remember disagreeing with it.' },
  { id: 'w_awakened_09', tier: 'awakened', context: 'menu', text: 'Your handwriting in the margins is starting to slant like someone else\'s.' },
  ...
  { id: 'w_awakened_12', tier: 'awakened', context: 'menu', text: 'Understanding feels good. That is exactly why it should worry you.' },
  ...
  { id: 'w_unmoored_07', tier: 'unmoored', context: 'menu', text: 'You check your own name in your notes, just to be sure it still matches.' },
  { id: 'w_unmoored_08', tier: 'unmoored', context: 'menu', text: 'Your inventory is exactly as you left it. You still count it twice.' },
  ...
  { id: 'w_unmoored_12', tier: 'unmoored', context: 'menu', text: 'Being known this completely was supposed to feel worse than this.' },
  ...
  { id: 'w_transcendent_06', tier: 'transcendent', context: 'menu', text: 'You reread your own history and it reads, now, like something you are proud of and grieving at once.' },
  { id: 'w_transcendent_07', tier: 'transcendent', context: 'menu', text: "It is not asking permission anymore. It stopped needing to somewhere around page eighty." },
  ...
  { id: 'w_transcendent_10', tier: 'transcendent', context: 'menu', text: 'The fear is still there. It is just filed under something gentler now.' },
