...
export const SHARD_SHOP: ShardShopEntry[] = [
  ...
  { id: 'archive_clearance', name: 'Archive Writ', cost: 200, description: 'Start with +10 Archive Influence.' },
  ...
  { id: 'true_sight', name: 'True Sight', cost: 500, description: 'Begin every fight with two affinity slots already revealed.' },
  { id: 'new_game_plus', name: 'New Game+', cost: 1000, description: 'Enemies +25%. The Beneath remembers — and a fourth fate becomes possible.' },
];
